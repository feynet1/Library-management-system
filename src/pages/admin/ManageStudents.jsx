...
const ManageStudents = () => {
    ...
    const loadStudents = useCallback(async () => {
        const result = await fetchUsersByRole('student');
        if (result.error) setError('Failed to load students.');
    ...
    useEffect(() => {
        ...
        const channel = supabase
            ...
            .on('postgres_changes', { event: '*', schema: 'public', table: 'profiles', filter: "role=eq.student" }, loadStudents)
            .subscribe();
